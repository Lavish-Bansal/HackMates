...
//               <NavLink
//               to="/dashboard"
//               className="flex items-center mb-5 pl-4 py-2" activeClassName="active">
//                 <span className=' text-[25px] mr-5'><AiFillProject /></span>Hackathon
//               </NavLink>
//             </li>
...
//                 <span className=' text-[25px] mr-5'><MdAccountCircle /> </span>Profile
//               </NavLink>
//             </li>


//             <li className='hover:shadow-md hover:bg-blue-500 rounded-md transition-all 200ms ease'>
//               <NavLink className="flex items-center mb-5 pl-4 py-2 pr-2" to='/updatePage' activeClassName="active">
//                 <span className=' text-[25px] mr-5'><MdAddToPhotos /> </span>Create team
//               </NavLink>
//             </li>

//             <li className='hover:shadow-md hover:bg-blue-500 rounded-md transition-all 200ms ease'>
//               <NavLink className="flex items-center mb-5 pl-4 py-2" to='/chat' activeClassName="active">
//                 <span className=' text-[25px] mr-5'><IoChatbubbleEllipses /></span>
//                 Chat
//               </NavLink>
//             </li>
